...
HELP_STRING = f"😈☠️𝓃𝒶𝔨𝕦ᒪ'ｓ😈 ⒻⓊς𝓀𝓔Ř ｂσｔ☠️😈  ★\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @Rajput_hu**"
...
HELP_BUTTON = [
    ...
    [
      Button.url(" 𝐂ʜᴀɴɴᴇʟ ", "https://t.me/THE_FUKER_BOT_2926"),
      Button.url("𝐒ᴜᴘᴘᴏʀᴛ ", "https://t.me/THE_FUCKING_BOTS_2926")
    ]
  ]
        ...
        await event.edit(
            ...
            buttons=[
              ...
              [
                ...
                Button.url("𝗖ʜᴀɴɴᴇʟ ", "https://t.me/THE_FUKER_BOT_2926"),
                Button.url("𝗦ᴜᴘᴘᴏʀᴛ ", "https://t.me/THE_FUCKING_BOTS_2926")
                Button.url("Developer ", "https://t.me/Rajput_hu")
                
            ],
          )
    else:
        await event.answer("ᴍᴀᴋᴇ ʏᴏᴜʀ ᴏᴡɴ  sᴘᴀᴍ  ʙᴏᴛs !! @Rajput_hu", cache_time=0, alert=True)
